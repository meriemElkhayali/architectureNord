...
export default function Accueil2() {
  ...
  <section >
      <div class="parallax-one" >
        <h2>STE ABDO ARCHI NORD SARL</h2>
      </div>
  </section>
  <section style={{ backgroundColor:'white' }}>
    <div class="block">
    <p><span class="first-character sc">A</span>
	...
	<source src="/image/VDO6.mp4"  type="video/mp4"/>
    </video> 
    {/* <video autoplay loop muted plays-inline class="back-video">
<source src="vdbg.mp4" type="video/mp4"/>
</video> */}
    </div>
    {/* <video style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto' }} controls>
  <source src='vdbg.mp4' type='video/mp4' />
</video> */}
  </section>
